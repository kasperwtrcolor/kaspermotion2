...
# Vibetrailer Cinematic Engine

VibeTrailer is an advanced AI-powered video production platform designed to transform websites, product descriptions, or raw scripts into high-impact cinematic choreography. By combining the reasoning power of Google Gemini with a high-performance React-based rendering engine, Vibetrailer automates the entire creative pipeline—from scriptwriting and scene direction to final video export.
...
- **AI**: Google Gemini
- **Backend**: Node.js, Express, Firebase Firestore/Storage, Render
