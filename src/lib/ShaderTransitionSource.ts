/**
 * ShaderTransitionSource.ts
 * 
 * Complete reimplementation using HyperFrames (@hyperframes/shader-transitions) 
 * shader source code. These are the EXACT same GLSL shaders from the HyperFrames
 * registry, ensuring identical visual output.
 * 
 * License: Apache 2.0 (heygen-com/hyperframes)
 */

// ============================================================================
// Vertex Shader — matches HyperFrames vertSrc exactly
// Flips Y for WebGL coordinate system
// ============================================================================
...
// ============================================================================
// Shared uniform header (H) — every fragment shader starts with this
// ============================================================================
const H =
...
// ============================================================================
// Quintic C2 noise + inter-octave rotation FBM (NQ)
// ============================================================================
const NQ =
...
// ============================================================================
// Shader Library — exact match to HyperFrames registry
// ============================================================================
...
// All available shader names for random selection
export const ALL_SHADER_NAMES = Object.keys(SHADER_LIBRARY).filter(n => n !== 'fade');

// Export shader name type for type safety
export type ShaderName = keyof typeof SHADER_LIBRARY;
